...
<head>
    ...
    <title>برنامج السمات</title>
    <link rel="apple-touch-icon" href="../../../newlogo.png">
    <link rel="shortcut icon" type="image/x-icon" href="../../../newlogo.png">
                        ...
                        <div class="card mb-0">
                            <div class="card-body">
                                <a href="index.html" class="brand-logo">
                                    <h2 class="brand-text text-primary ms-1">برنامج السمات</h2>
                                </a>

                                <form method="POST" action="{{ route('login') }}">
                                    @csrf
                                    <div>
                                        <x-input-label for="email" value="ايميل" />
                                    ...
                                    <div class="flex items-center justify-end mt-1">
                                        ...
                                        <button type="submit" style="width: 70%" class="ms-3 btn btn-primary">
                                            تسجيل الدخول
                                        </button>
                                    </div>
                                </form>
