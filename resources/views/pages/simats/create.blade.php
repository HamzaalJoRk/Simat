        ...
        <form action="{{ route('simats.store') }}" method="POST" id="simat-form">
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-2 position-relative">
                    ...
                    <!-- هذا فقط للاستخدام الداخلي في JavaScript -->
                ...
                <div class="col-md-4 mb-2">
                    ...
                    <input type="number" name="fee_number" value="{{ old('fee_number') }}" class="form-control" required>
                </div>
                <div class="col-md-4 mb-2">
                    <label>الرسوم كتابة:</label>
                    <input type="text" name="fee_text" value="{{ old('fee_text') }}" class="form-control" required>
                </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.querySelectorAll('.nationality-item').forEach(item => {
                item.addEventListener('click', function () {
                    // ننتظر لحظة بعد اختيار الجنسية لتحديث قيمة input المخفي
