...
@section('content')
    <div class="container">
        <div class="d-flex justify-content-between align-items-center mb-1">
            <h2 class="fw-bold">سجل تأمينات الشحن</h2>
            <div>
                @if (auth()->user()->hasRole('Cargo Insurance'))
        ...
        <form method="GET" action="{{ route('insurances.indexCargo') }}" class="row mb-1">
            <div class="col-md-4">
            ...
            <div class="col-md-4 d-flex align-items-end">
                ...
                <a href="{{ route('insurances.indexCargo') }}" class="btn btn-secondary">إعادة تعيين</a>
            </div>
        </form>
